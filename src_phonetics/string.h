...
// Stringdefinitionen
// ---------------------------------------------------------------------------------------------------------------------
// Fixstringtyp für ein Wort (Größe kann erhöht werden)
#define BUFFSIZE_WORD             64
typedef char                      word_t[BUFFSIZE_WORD];

// Rückgabekonstannten
#define STR_TO_WORD_SUCCESS       0
#define STR_TO_WORD_ERR_NO_WORD   1
#define STR_TO_WORD_ERR_OVERLEN   2
// ---------------------------------------------------------------------------------------------------------------------
// Stringfunktionen
// ---------------------------------------------------------------------------------------------------------------------
...
// Rückgabe:  STR_TO_WORD_SUCCESS       bei Erfolg
//            STR_TO_WORD_ERR_NO_WORD   wenn kein gültiges deutsches Wort
//            STR_TO_WORD_ERR_OVERLEN   wenn src nicht in dest paßt
