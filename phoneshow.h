...
#define STAT_PARAM_ERR		6		// ungültige Übergabeparameter
#define STAT_STDIN_ERR		7		// Überlange Textzeilen von stdin erhalten
#define STAT_MEM_ERR		8		// Fehler bei Speicheranforderung
#define STAT_SHOW_EXAMPLES	254		// Beispiele anzeigen
#define STAT_SHOW_HELP		255		// Hilfe angezeigen

// Puffergröße lesen von stdin
// Wenn Textzeilen größerer Länge eintreffen, wird Fehler ausgelöst
...
// Für Optionen Phonetik & Formatierung
typedef struct {
